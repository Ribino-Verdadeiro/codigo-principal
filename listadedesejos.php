                ...
                <tbody>
                    <?php foreach ($_SESSION['wishlist'] as $id => $item): ?>
                        <tr>
                            ...
                            <td>
                            <a href="remover_lista.php?id=<?php echo urlencode($id); ?>" class="btn btn-danger btn-sm remover">Remover</a>
                            <form action="carrinhodecompras.php" method="post" style="display: inline;">
                                <input type="hidden" name="id" value="<?php echo $id; ?>">
                                <button type="submit" class="btn btn-success btn-sm adicionar">Adicionar ao Carrinho</button>
                            </form>
                            </td>
                        </tr>
                    <?php endforeach; ?>
